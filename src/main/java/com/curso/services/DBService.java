...
public class DBService {
    ...
    public void initDB() {
        ...
        dto1.setNomeCliente("JOSIVAL");
        dto1.setValor(new BigDecimal("15000.00"));
        dto1.setTipoFrete("AVIAO");
        dto1.setEstadoAtual("AGUARDANDO_PAGAMENTO");

        PedidoDTO dto2 = new PedidoDTO();
        dto2.setNomeCliente("GUILHERME");
        dto2.setValor(new BigDecimal("1000.00"));
        dto2.setTipoFrete("CAMINHAO");
